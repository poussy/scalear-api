...
ActiveRecord::Schema.define(version: 20171017085351) do
  ...
  create_table "guest_enrollments", force: :cascade do |t|
    t.integer "user_id"
    t.integer "course_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["course_id"], name: "index_guest_enrollments_on_course_id"
    t.index ["user_id"], name: "index_guest_enrollments_on_user_id"
  end
