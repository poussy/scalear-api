Rails.application.configure do
  ...
  # Enable serving of images, stylesheets, and JavaScripts from an asset server.
   config.action_mailer.asset_host = 'https://www.scalable-learning.com'
  ...
  # config.active_job.queue_name_prefix = "scalear-api_#{Rails.env}"
  ...
  config.action_mailer.smtp_settings = {
    ...
    :password       => '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',#ENV['SENDGRID_PASSWORD'],
    :domain         => 'heroku.com',
