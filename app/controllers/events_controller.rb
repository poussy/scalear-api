...
class EventsController < ApplicationController
	...
	def correct_user
		...
		p 'course_idcourse_idcourse_idcourse_id'
		pp @course
		if !(@course.users.include? current_user) && !(@course.guests.include? current_user) && !(@course.teachers.include? current_user) && !current_user.is_administrator? && !(@course.is_school_administrator(current_user))  #&& not administrator.
