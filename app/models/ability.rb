    ...
    if user.has_role? 'User'
      ...
      ## Lecture
        can [:create, :index, :update, :destroy, :show, :new_lecture_angular, :get_old_data_angular, :get_html_data_angular, :new_quiz_angular, :new_marker,
             ...
             :lecture_copy,  :create_or_update_survey_responses, :update_vimeo_video_data,:delete_complete_link,:get_vimeo_upload_details,:get_uploading_status, :get_vimeo_video_id,:delete_vimeo_video_angular, :update_vimeo_table,:change_status_angular, :delete_response, :confused_show_inclass], Lecture do |lecture|
