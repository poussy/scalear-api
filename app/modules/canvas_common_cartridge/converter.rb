module CanvasCommonCartridge::Converter
    ...
    def convert_video_survey(lecture,lecture_surveys,converted_group,converted_course)
        ...
        converted_video_survey_title +='[MISSING ANSWERS]'  if lecture_surveys.pluck(:quiz_type).include?"survey" && lecture_surveys.online_answers.pluck(:answer).include?("Answer 1")
